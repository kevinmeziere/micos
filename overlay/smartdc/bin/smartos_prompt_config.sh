...
# micos: register default nat stub
echo "etherstub=natsw0" >>$tmp_config
# micos:

# micos: output TZ option
...
# micos: now create /opt/custom/smf and place ours
mkdir -p ${OPTDS}/custom/smf
cp -p /micos/share/smartos/root_bashrc.xml ${OPTDS}/custom/smf/
cp -p /micos/share/smartos/bashrc ${OPTDS}/custom/.bashrc
# micos:
