# usage: assemble.sh <micos-ver> <dist-iso-dir> <smartos-usb-img-path>

MICOS_VER=$1
MICOS_ISO_PATH=$2/${MICOS_VER}.iso
SMARTOS_USB_PATH=$3

USBIMG=${MICOS_VER}.img
USBSIZE=2000000000
